/********************************************************************
Module : SpyControl.h - part of ApiSpyDll implementation 
...
static const TCHAR s_szApiSpyDll[] = _T("ApiSpyDll.dll");
static const TCHAR s_szSettingsRegPath[] = _T("Software\\ApiSpy");
